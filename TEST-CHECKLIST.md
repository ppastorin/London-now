...
- [ ] `/api/health` reports version `0.6.2` and TfL `registered`.
...
- [ ] `/api/health` returns HTTP 200 and version `0.6.2`.
...
- [ ] Approved commit is tagged `v0.6.2-affiliate-event-title-approved`.
